        ...
        <div className='container position-relative z-2'>
          <div className='text-center'>
            ...
            <h3 className='ds-3 my-3 fw-regular'>
              Bizi öne çıkaran <span className=' fw-bold'>gurur </span>{" "}
              <br className='d-none d-lg-inline' /> verici{" "}
          ...
          <div className='row mt-8'>
            <div className='col-lg-6 mt-lg-0 mt-5'>
              ...
              <p className='fs-5 text-500'>
                Nunc bibendum augue sed mattis porta. Donec pharetra magna
                tortor, quis bibendum ligula faucibus vitae,
              </p>
                ...
                <div className='px-0 card p-3 border-0 border-bottom bg-transparent rounded-0'>
                  ...
                  >
                    <p className='px-0 card-body fs-6 text-600'>
                      ...
                      email or social media login, and start making video calls
                      instantly.
                    </p>
                  </div>
                </div>
            ...
            <div className='col-lg-6 px-lg-6 mt-lg-0 mt-8'>
              ...
              >
                ...
                <div className='content mt-md-0 mt-4 ms-5'>
                  ...
                  <p>
                    As the SaaS industry continues to evolve, new trends are
                    shaping the future of software delivery and consumption...
                  </p>
                </div>
              </Link>
              <Link
